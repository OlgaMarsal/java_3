package lesson_four_java_three_multithreading_one;

import lesson_one_java_three.Main;

public class MainLessonFour {

    volatile int status = 0;
    public static void main(String[] args) {
        MainLessonFour lock = new MainLessonFour();
...
class Task implements Runnable {
    ...
    private final MainLessonFour lock;
    private int p;

    Task(String text, MainLessonFour obj, int p) {
        message = text;
        this.lock = obj;
        this.p = p;
    }
